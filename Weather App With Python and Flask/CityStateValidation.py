class ValidatingState:
   ...
   #state valdiation is based off git repo dictionary of city

    def state_with_abv_look_up(self,city,state): # Looking for city state validation, makes sure city belongs to state
        found_values = []
        state_confirmed = ''
    ...
    def abv_state_record(self,abv): # validating user input of abbrvations and seeing if it exists then returning the state as ok returning OKLAHOMA
        state = ''
    ...
    def state_look_up(self, city): #finding the city and getting the abbrvation state incase user doesnt provide a correct city state
        found_values = []
        state = ''
        list_of_state_dictionaries = self.state_city_combination()

        for dictionary in list_of_state_dictionaries:
            if (dictionary["city"] == city):
                found_values.append(dictionary)
    ...
    def state_abv_lookup(self,state):# finding the abv of state for
        state_abv = ''
